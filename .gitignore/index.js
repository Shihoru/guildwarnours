...
//------------------------------------------ROAD1-------------------------------------------------------------------------
        ...
        .then(message.awaitReactions(filter, {max : 12, time: 360000, errors: ['time']  })
        .then(collected => {
            const reaction = collected.last();
        ...
        .then(message.awaitReactions(filter, {max : 13, time: 360000, errors: ['time']  })
        .then(collected => {
        ...
        .then(message.awaitReactions(filter, {max : 14, time: 360000, errors: ['time']  })
        .then(collected => {
            const reaction = collected.last();
        ...
        .then(message.awaitReactions(filter, {max : 15, time: 360000, errors: ['time']  })
        .then(collected => {
